...
frases = [
    ...
    {"id": 51, "frase": "El esfuerzo de hoy es el éxito de mañana"},
    {"id": 52, "frase": "Pequeñas victorias construyen grandes triunfos"},
    {"id": 53, "frase": "No esperes el momento perfecto, créalo"},
    {"id": 54, "frase": "Cada error es una lección disfrazada"},
    {"id": 55, "frase": "La fuerza no viene del cuerpo, viene de la voluntad"},
    {"id": 56, "frase": "Empieza donde estás, usa lo que tienes"},
    {"id": 57, "frase": "El que persiste, triunfa"},
    {"id": 58, "frase": "No busques el camino fácil, busca el camino que valga la pena"},
    {"id": 59, "frase": "Tu historia no ha terminado aún"},
    {"id": 60, "frase": "Sé la razón por la que alguien cree en sí mismo"},
    {"id": 61, "frase": "Conviértete en la mejor versión de ti"},
    {"id": 62, "frase": "Las grandes cosas llevan tiempo"},
    {"id": 63, "frase": "Actúa como si fuera imposible fallar"},
    {"id": 64, "frase": "La gratitud abre puertas que el esfuerzo solo no puede abrir"},
    {"id": 65, "frase": "No necesitas velocidad, necesitas dirección"},
    {"id": 66, "frase": "Un día a la vez, un paso a la vez"},
    {"id": 67, "frase": "La confianza en uno mismo es el primer secreto del éxito"},
    {"id": 68, "frase": "Transforma tus heridas en sabiduría"},
    {"id": 69, "frase": "Lo que siembras hoy, lo cosecharás mañana"},
    {"id": 70, "frase": "Nunca dejes de aprender, nunca dejes de crecer"},
]
